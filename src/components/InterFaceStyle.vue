<template>
  <div id="app" >
    ...
    <div id="bottomGlobal" style="height:13rem;width:100%;display:flex;margin-top:1%;">
      ...
      <div class="resibox">
        ...
        <div class="residown">
          ...
          <el-table
              ...
              <el-table-column label="Order Line" width="100" >
              ...
              <el-table-column  label="Ablation Res" width="200">
                <template slot-scope="scope">
                  <div v-if="taskType=='Classification'"  class="valueBar" style="display:flex;">
                    <el-progress  color="red" :width="65" :height="65" type="circle" :percentage="50" :format="valueFormat" >
                    </el-progress>
                    <div style="align:center;margin:auto;">
                      <b>Class1:{{scope.row.value[0]}}</b>
              ...
              <el-table-column  label="Reorder Res" width="200">
                <template slot-scope="scope">
                  <div v-if="taskType=='Classification'"  class="valueBar" style="display:flex;">
                    ...
                    <div style="align:center;margin:auto;">
                      <b>Class1:{{scope.row.resValue[0]}}</b>
...
export default {
  ...
  methods: {
          ...
          dragControllerDiv: function () {
            ...
            var top = document.getElementsByClassName('resitop');
            var down = document.getElementsByClassName('residown');
            var box = document.getElementsByClassName('resibox');
            for (let i = 0; i < resize.length; i++) {
              ...
              resize[i].onmousedown = function (e) {
                ...
                document.onmousemove = function (e) {
                  ...
                  console.log('beforeTop',resize[i].top)
                  var moveLen = resize[i].top + (endY - startY)-630; // （endx-startx）=移动的距离。resize[i].left+移动的距离=左边区域最后的宽度
                  ...
                  console.log('top[j].style.height',top[0].style.height)
                  for (let j = 0; j < top.length; j++) {

                    top[j].style.height = moveLen + 'px';
                    down[j].style.height = (box[i].clientHeight - moveLen - 50) + 'px';
                  }
                }
                // 鼠标松开事件
    ...
    */
    ...
    setTreeMap: function(thedata){
      ...
      var data=[{'name':'Class1','children':posChilds,'value':posValue},
                {'name':'TrainData','children':negChilds,'value':negValue}];
